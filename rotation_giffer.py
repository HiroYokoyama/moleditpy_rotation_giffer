...
def show_giffer_dialog(context):
    # Singleton Pattern: Check if the window is already active
...
class GifferDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        if not HAS_PIL:
            ...
            self.transparency_check.setToolTip("PIL (Pillow) library is required to export transparent GIFs.")
        ...
        try:
            ...
            if use_transparency and HAS_PIL:
                ...
                for i in range(frames):
                    ...
                    self._orbit_camera(plotter, axis_idx, step, i + 1, initial_pos_coord, initial_cam_up)
                ...
                for i in range(frames):
                    plotter.write_frame()
                    self._orbit_camera(plotter, axis_idx, step, i + 1, initial_cam_pos, initial_cam_up)
    ...
    def _orbit_camera(self, plotter, axis_idx, step, frame_idx=1, initial_pos=None, initial_up=None):
        cam = plotter.camera
